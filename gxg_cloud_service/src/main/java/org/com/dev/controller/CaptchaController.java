...
public class CaptchaController {
    ...
    @RequestMapping(value="/checkCaptchaCode",method={RequestMethod.POST,RequestMethod.GET})
    @ResponseBody
    public String checkCaptchaCode(HttpServletRequest request,String captchaCode){
